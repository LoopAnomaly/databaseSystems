            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('CustRegisterPage') }}" style="text-decoration: underline">Customer Registration</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('BusRegisterPage') }}" style="text-decoration: underline">Business Registration</a>
                        </li>
                        @endif
                    </ul>
                    @if(Session::has('acct_no'))
                    ...
                    @endif
                    <form class="form d-flex" method="post" action="{{ route('Authenticate') }}" accept-charset="UTF-8">
