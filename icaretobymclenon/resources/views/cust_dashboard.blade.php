        ...
        <nav class="navbar navbar-expand-lg navbar-light " style="background-color: beige;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form d-flex" method="get" action="{{ route('UpdateInfoPage') }}" accept-charset="UTF-8">
        ...
        <div class="row container-fluid">
            ...
            <table class="table mt-5" style='background-color: whitesmoke'>
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row" class="table-active">{{$match->service_type}}</th>
                        <td class="table-active">{{$match->name}}</td>
                        <td class="table-active">{{$match->service_cost}}</td>
                        <td class="table-active">{{($match->has_contract == 0) ? "No" : "Yes"}}</td>
                        @if (Session::has('button_' . $loop->iteration))
            ...
            <div class="col-6 offset-3">
                <form class="form d-flex" method="get" action="{{ route('Preferences') }}" accept-charset="UTF-8">
