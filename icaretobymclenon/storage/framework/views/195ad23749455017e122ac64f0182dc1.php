        ...
        <div class="row container-fluid">
            ...
            <table class="table" style='background-color: whitesmoke'>
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row" class="table-active"><?php echo e($match->first_name); ?></th>
                        <td class="table-active"><?php echo e($match->last_name); ?></td>
                        <td class="table-active"><?php echo e($match->email); ?></td>
                        <td class="table-active"><?php echo e($match->phone_no); ?></td>
                        <td class="table-active"><?php echo e($match->service_type); ?></td>
                        <td class="table-active"><?php echo e(empty($match->current_cost) ? 0 : $match->current_cost); ?></td>
                        <td class="table-active"><?php echo e(($match->contract_exp == "None" || $match->contract_exp == null) ? "No" : "Yes"); ?></td>
                        <td class="table-active"><?php echo e(empty($match->description) ? "No Description" : $match->description); ?></td>
            ...
            <?php $__currentLoopData = $custs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                        <th scope="row" class="table-active"><?php echo e($cust->service_type); ?></th>
                        <td class="table-active"><?php echo e(empty($cust->current_cost) ? 0 : $cust->current_cost); ?></td>
                        <td class="table-active"><?php echo e($cust->looking); ?></td>
                        <td class="table-active"><?php echo e(($cust->contract_exp == "None" || $cust->contract_exp == null) ? "No" : "Yes"); ?></td>
                    </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
            </table>
...
<?php /**PATH C:\xampp\htdocs\icaretobymclenon\resources\views/bus_dashboard.blade.php ENDPATH**/ ?>