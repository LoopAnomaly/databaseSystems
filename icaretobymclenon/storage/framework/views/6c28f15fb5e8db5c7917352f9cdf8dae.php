...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body style="background-color: darkkhaki;">
        ...
        <div class="col-6 offset-3">
            ...
            <form class="form" action="<?php echo e(route('BusUpdateInfo')); ?>" method="post" accept-charset="UTF-8">
                ...
                <?php $__currentLoopData = $bus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <h3 class='roboto-bold mt-5'>SERVICE TYPE:</h3>
                <div class="form-group mt-3">
                    <input type="text" class="form-control" name="first_name" placeholder="First Name" value="<?php echo e($b->service_type); ?>"/>
                </div>

                <h3 class='roboto-bold mt-5'>SERVICE COST:</h3>
                <div class="form-group mt-3">
                    <input type="text" class="form-control" name="last_name" placeholder="Last Name" value="<?php echo e($b->service_cost); ?>"/>
                </div>
...
<?php /**PATH C:\xampp\htdocs\icaretobymclenon\resources\views/bus_update_info.blade.php ENDPATH**/ ?>