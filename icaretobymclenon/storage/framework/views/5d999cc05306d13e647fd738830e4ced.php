...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body style="background-color: darkkhaki;">
        ...
        <div class="col-6 offset-3">
            ...
            <form class="form" action="<?php echo e(route('UpdateInfo')); ?>" method="post" accept-charset="UTF-8">
                ...
                <div class="form-group mt-3">
                    <input type="text" class="form-control" name="first_name" placeholder="First Name" value="<?php echo e($cust[0]->first_name); ?>"/>
                </div>

                <h3 class='roboto-bold mt-5'>LAST NAME:</h3>
                <div class="form-group mt-3">
                    <input type="text" class="form-control" name="last_name" placeholder="Last Name" value="<?php echo e($cust[0]->last_name); ?>"/>
                </div>

                <h3 class='roboto-bold mt-5'>ADDRESS:</h3>
                <div class="form-group mt-3">
                    <input type="text" class="form-control" name="address" placeholder="Address" value="<?php echo e($cust[0]->address); ?>"/>
                </div>

                <h3 class='roboto-bold mt-5'>EMAIL:</h3>
                <div class="form-group mt-3">
                    <input type="text" class="form-control" name="email" placeholder="Email Address" value="<?php echo e($cust[0]->email); ?>" />
                </div>

                <h3 class='roboto-bold mt-5'>PHONE NUMBER:</h3>
                <div class="form-group mt-3">
                    <input type="text" class="form-control" name="phone_no" placeholder="Phone Number" value="<?php echo e($cust[0]->phone_no); ?>" />
                </div>
...
<?php /**PATH C:\xampp\htdocs\icaretobymclenon\resources\views/update_info.blade.php ENDPATH**/ ?>